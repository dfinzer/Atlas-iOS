...
/**
 ...
 @param completion The completion block to be called upon retreival of the participants.
 */
- (void)addressBarViewController:(ATLAddressBarViewController *)addressBarViewController retreivePrefilledParticipantsWithCompletion:(void (^)(NSArray *participants))completion;
